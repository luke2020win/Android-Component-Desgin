 ...
 */
@EFModuleAnnotation(moduleName = "a-cc-main",delegateName = "com.freebank.mian.MainApplicationDelegate")
public class MainApplicationDelegate implements IApplicationDelegate {

    private static final String TAG = MainApplicationDelegate.class.getSimpleName();
