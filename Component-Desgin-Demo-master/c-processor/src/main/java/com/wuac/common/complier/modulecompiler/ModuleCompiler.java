package com.wuac.common.complier.modulecompiler;
...
import com.wuac.common.complier.info.ModuleProxyInfo;
import com.wyac.common.annotations.EFModuleAnnotation;

/**
 * 编译时注解,编译时注解注解处理器的实现主要依赖于AbstractProcessor来实现
 * 编译时注解的核心就是实现AbstractProcessor的process()方法
 * 一般来说主要有以下两个步骤
