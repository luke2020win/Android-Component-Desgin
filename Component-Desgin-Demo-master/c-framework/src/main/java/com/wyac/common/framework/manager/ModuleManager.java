package com.wyac.common.framework.manager;

import android.content.Context;
import android.content.res.AssetManager;

import com.wyac.common.framework.base.BaseApplication;
import com.wyac.common.framework.module.entity.ModuleInfo;
import com.wyac.common.framework.module.interfaces.IApplicationDelegate;
import com.wyac.common.framework.module.utils.ModuleClassUtils;
        ...
        try {
            ...
            for(int i = 0; i < fileLength; ++i) {
                ...
                if(fileName.startsWith(MODULE_PREFIX)) {
                    ...
                    EFLog.d(TAG, "load Module: " + moduleInfo.getDelegateName());
                }
            }
